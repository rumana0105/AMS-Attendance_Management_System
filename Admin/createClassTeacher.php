...
if (isset($_POST['save'])) {
    ...
    $query = "INSERT INTO tblclassteacher(firstName, lastName, emailAddress, password, phoneNo, classId, classArmId, dateCreated) 
    VALUES ('$firstName', '$lastName', '$emailAddress', '$sampPass_2', '$phoneNo', '$classId', '$classArmId', '$dateCreated')";
    
    // Commented out the debugging line
    // echo $query; 
...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit") {
    ...
    if (isset($_POST['update'])) {
        ...
        // Ensure $password is defined or set it to a new value
        $password = "newpassword"; // Set a new password or retrieve it from the form if needed
