...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"insert into tblstudents(firstName,lastName,admissionNumber,password,classId,classArmId,dateCreated) 
    value('$firstName','$lastName','$admissionNumber','12345','$classId','$classArmId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName',
    admissionNumber='$admissionNumber',password='12345', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
            if ($query) {
                        ...
                        if($num > 0) { 
                            while ($rows = $rs->fetch_assoc()) {
                                ...
                                echo "<tr>
                                    ...
                                    <td>".htmlspecialchars($rows['dateCreated'])."</td>
